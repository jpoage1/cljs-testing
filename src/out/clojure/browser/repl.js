...
var seq__1896_1900 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1897_1901 = null;
var count__1898_1902 = (0);
var i__1899_1903 = (0);
while(true){
if((i__1899_1903 < count__1898_1902)){
var str_1904 = cljs.core._nth.call(null,chunk__1897_1901,i__1899_1903);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1904})));
...
var c__4550__auto___1911 = cljs.core.chunk_first.call(null,seq__1896_1910__$1);
var G__1912 = cljs.core.chunk_rest.call(null,seq__1896_1910__$1);
var G__1913 = c__4550__auto___1911;
var G__1914 = cljs.core.count.call(null,c__4550__auto___1911);
var G__1915 = (0);
...
var str_1916 = cljs.core.first.call(null,seq__1896_1910__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1916})));
...
var script__$1 = (function (){var G__1925 = script;
goog.object.set(G__1925,"type","text/javascript");

goog.object.set(G__1925,"onload",onload);

goog.object.set(G__1925,"onreadystatechange",onload);

return G__1925;
})();
if((opt_sourceText == null)){
var G__1926 = script__$1;
goog.object.set(G__1926,"src",src);

return G__1926;
} else {
var G__1927 = script__$1;
goog.dom.setTextContext(G__1927,opt_sourceText);
...
var path_1928 = goog.debugLoader_.getPathFromDeps_(cljs.core.name);
goog.object.remove(goog.debugLoader_.written_,path_1928);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1928)].join(''));
} else {
var path_1929 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_1929);

goog.object.remove(goog.dependencies_.written,path_1929);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1929)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1930 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1931 = repl;
clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1931;

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1930;
}})()})));
});})(connected_QMARK_,repl_connection))
);
