...
var o2234 = temp__5718__auto__;
var temp__5718__auto____$1 = (o2234["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o2235 = temp__5718__auto____$1;
return (o2235["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__1315__auto__ = f;
return (o__1315__auto__["toString"]).call(o__1315__auto__);
} else {
return "";
}
}catch (e2236){var _ = e2236;
return "";
}});
...
try{var o__1315__auto___2238 = t;
(o__1315__auto___2238["cljs$lang$ctorPrWriter"]).call(o__1315__auto___2238,t,writer);
}catch (e2237){var __2239 = e2237;
}
...
var char_code = (function (){var o__1315__auto__ = (new String(char$));
return (o__1315__auto__["charCodeAt"]).call(o__1315__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__1315__auto__ = String;
return (o__1315__auto__["fromCharCode"]).call(o__1315__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__2240 = num_code;
switch (G__2240) {
case (1):
return (185);
...
var o__1315__auto__ = String;
return (o__1315__auto__["fromCharCode"]).call(o__1315__auto__,superscript_code);
});
/**
...
}catch (e2242){var _e__1322__auto__ = e2242;
return false;
}})())){
...
var vec__2243 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__2243,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o2246 = temp__5718__auto__;
var temp__5718__auto____$1 = (o2246["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o2247 = temp__5718__auto____$1;
return (o2247["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__2250){
var vec__2251 = p__2250;
var ns_detector = cljs.core.nth.call(null,vec__2251,(0),null);
...
var G__2257 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__2258 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__2257;
remaining_tokens = G__2258;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq2248){
...
var vec__2262 = cljs.core.split_with.call(null,(function (p1__2261_SHARP_){
return cljs.core.not_EQ_.call(null,p1__2261_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__2262,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__2262,(1),null);
...
var vec__2268 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__2268,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__2268,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__2271 = cljs.core.rest.call(null,remaining_tokens);
var G__2272 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__2271;
name_tokens = G__2272;
continue;
} else {
...
var vec__2275 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__2275,(0),null);
var arity = cljs.core.nth.call(null,vec__2275,(1),null);
var vec__2278 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__2278,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__2278,(1),null);
var vec__2281 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__2281,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__2281,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__2281,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__2281,(3),null);
...
var vec__2287 = result;
var munged_ns = cljs.core.nth.call(null,vec__2287,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__2287,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__2287,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__2287,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__2287,(4),null);
var arity = cljs.core.nth.call(null,vec__2287,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__2291 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__2291,(0),null);
var args = cljs.core.nth.call(null,vec__2291,(1),null);
var vec__2294 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__2294,(0),null);
var name = cljs.core.nth.call(null,vec__2294,(1),null);
...
var G__2297 = (arity + (1));
var G__2298 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__2299){
var vec__2300 = p__2299;
var arity = cljs.core.nth.call(null,vec__2300,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__2300,(1),null);
...
return (function (p1__2303_SHARP_){
return cljs.core.get.call(null,arities,p1__2303_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__2304_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___2311 = arguments.length;
var i__4731__auto___2312 = (0);
while(true){
if((i__4731__auto___2312 < len__4730__auto___2311)){
args__4736__auto__.push((arguments[i__4731__auto___2312]));

var G__2313 = (i__4731__auto___2312 + (1));
i__4731__auto___2312 = G__2313;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__2307){
var vec__2308 = p__2307;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__2308,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq2305){
var G__2306 = cljs.core.first.call(null,seq2305);
var seq2305__$1 = cljs.core.next.call(null,seq2305);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__2306,seq2305__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__2316__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__2316__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__2316__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__2316__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__2317 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__2317,(0),null);
var fn_name = cljs.core.nth.call(null,vec__2317,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__2317,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__2317,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__2317,(4),null);
var arity = cljs.core.nth.call(null,vec__2317,(5),null);
...
var o__1315__auto__ = f;
return (o__1315__auto__["getBasis"]).call(o__1315__auto__);
});
/**
...
}catch (e2321){var _e__1322__auto__ = e2321;
...
var G__2322 = (obj[cljs.core.first.call(null,path)]);
var G__2323 = cljs.core.rest.call(null,path);
obj = G__2322;
path = G__2323;
continue;
} else {
...
return (function (accum,p__2324){
var vec__2325 = p__2324;
var bit = cljs.core.nth.call(null,vec__2325,(0),null);
var protocol = cljs.core.nth.call(null,vec__2325,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__2328){
var vec__2329 = p__2328;
var ns = cljs.core.nth.call(null,vec__2329,(0),null);
var name = cljs.core.nth.call(null,vec__2329,(1),null);
var selector = cljs.core.nth.call(null,vec__2329,(2),null);
...
return (function (p__2333){
var vec__2334 = p__2333;
var munged_name = cljs.core.nth.call(null,vec__2334,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__2334,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__2334,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__2332_SHARP_){
return (obj[cljs.core.first.call(null,p1__2332_SHARP_)]);
});})(name,sorted_matches,vec__2334,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1560926225061
